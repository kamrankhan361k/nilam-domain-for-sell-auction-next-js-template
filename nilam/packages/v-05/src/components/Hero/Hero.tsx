...
const Hero = () => {
  ...
  return (
    <section id="hero" className="lg:min-h-screen">
      <ToastContainer />

      <div className="grid items-center lg:min-h-screen justify--center lg:grid-cols-2">
        <div className="flex items-center justify-center px-10 py-16 bg-gray-900 lg:min-h-screen">
          <div className="relative mx-auto text-center text-white lg:max-w-xl max__width__wrap">
            <div
              className="p-10 m-3 bg-opacity-90 "
              style={{ backdropFilter: "blur(20px)" }}
            >
              <h1 className="uppercase text-brand">Domain.Com</h1>
              <h1 className="pb-5 mt-4 mb-5 sub-title">is for sale.</h1>
              <p className="text-white background-brand text-2xl inline-block py-2.5 mt-4 px-4 mb-6 pricing-before">
                Price $200 only
              </p>

              <p>
                The domain name (without content) is available for sale by its
                owner. Any offer you submit is binding for 7 days. If you
                require futher information contact with me.
              </p>
        ...
        <div className="flex items-center justify-center px-10 py-16 bg-form lg:min-h-screen">
          <div
            className="w-full px-8 pt-6 pb-8 mx-auto my-0 ml-auto bg-white border-t-8 max__width__wrap bg-opacity-90 lg:max-w-lg border-emerald-500"
            style={{ backdropFilter: "blur(20px)" }}
          >
